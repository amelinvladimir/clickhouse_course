...
### Наполняем файл файл docker-compose.yml
```yml
version: '3.8'
services:
  clickhouse-01:
...
##### fs/volumes/clickhouse-keeper-04/etc/clickhouse-keeper/keeper_config.xml
```xml
<clickhouse replace="true">
    <logger>
...
### Вставляем данные в распределенную таблицу
```sql
